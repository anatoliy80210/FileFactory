...
int main() {
	...
	char** myFile = FileFactory::toCStringArray(f);
	
	// print c-string array foward - const
	std::cout << "\nConst C-Strings - Forward" << std::endl;
	FileFactory::printArrayConst(myFile, f.size(), std::cout, FileFactory::PrintDirection::FORWARD);

	// print c-string array backward - const
	std::cout << "\nConst C-Strings - Backward" << std::endl;
	FileFactory::printArrayConst(myFile, f.size(), std::cout, FileFactory::PrintDirection::BACKWARD);

	// print c-string array foward - non const
	std::cout << "\nC-Strings - Forward" << std::endl;
	FileFactory::printArray(myFile, f.size(), std::cout, FileFactory::PrintDirection::FORWARD);

	// print c-string array backward - non const
	std::cout << "\nC-Strings - Backward" << std::endl;
	FileFactory::printArray(myFile, f.size(), std::cout, FileFactory::PrintDirection::BACKWARD);
